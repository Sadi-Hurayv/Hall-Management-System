...
if (isset($_POST['login'])) {
    ...
    $stmt=$mysqli->prepare("SELECT regNo,firstname,lastname,gender,email,password,id FROM userregistration WHERE email=? and password=? ");
    $stmt->bind_param('ss', $email, $password);
    $stmt->execute();
    $stmt -> bind_result($regno, $fname, $lname, $gender, $email, $password, $id);
    $rs=$stmt->fetch();
    $stmt->close();
