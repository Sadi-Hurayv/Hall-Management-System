...
<head>
	...
	<script language="javascript" type="text/javascript">
		...
		function popUpWindow(URLStr, left, top, width, height) {
			...
			popUpWin = open(URLStr, 'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width=' + 510 + ',height=' + 430 + ',left=' + left + ', top=' + top + ',screenX=' + left + ',screenY=' +
				top + '');
		}
	</script>
...
$mng_student_sql="SELECT * FROM registration";
$data=$mysqli->query($mng_student_sql);
$cnt=1;
